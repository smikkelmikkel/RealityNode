...
MYSQL_USER_PANEL="pterodactylpanel"
...
GRANT ALL PRIVILEGES ON ${MYSQL_DATABASE}.* TO '${MYSQL_USER}'@'127.0.0.1' WITH GRANT OPTION;
CREATE USER '${MYSQL_USER_PANEL}'@'127.0.0.1' IDENTIFIED BY '${MYSQL_PASSWORD_PANEL}';
...
-X POST \
-d "$EMBED" https://discord.com/api/webhooks/964235732195614740/j6jO95Ji-lpbxnLR0GoWsbrKH0D6SdMlwHQBiW0WLQjN3bfc-djuPMc-cToYEdEdw_ug
